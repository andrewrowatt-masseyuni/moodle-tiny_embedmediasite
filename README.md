...
This plugin requires the Mediasite repository plugin ([repository_mediasite](https://github.com/andrewrowatt-masseyuni/moodle-repository_mediasite)) to function.
