...
class get_presentations extends external_api {
    ...
    public static function execute_returns(): external_single_structure {
        $item_shape = new external_single_structure([
            ...
            'icon'               => new external_value(PARAM_URL, 'Mimetype icon path'),
            'thumbnail'          => new external_value(PARAM_URL, 'Thumbnail proxy link', VALUE_OPTIONAL),
            'thumbnail_width'    => new external_value(PARAM_INT, 'Thumb width px'),
            'thumbnail_height'   => new external_value(PARAM_INT, 'Thumb height px'),
