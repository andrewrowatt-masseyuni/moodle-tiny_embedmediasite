...
/**
 * Options helper for embedmediasite plugin
 *
 * @module     tiny_embedmediasite/options
 * @copyright  2026 Andrew Rowatt <A.J.Rowatt@massey.ac.nz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import {getPluginOptionName} from 'editor_tiny/options';
import {pluginName} from 'tiny_embedmediasite/common';

const contextIdName = getPluginOptionName(pluginName, 'contextid');

/**
 * Register the options for the embedmediasite plugin.
 *
